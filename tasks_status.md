...
- [ ] **Game Title & Branding**
  - [x] Update the game title, splash screen, and app icon to reflect the capybara theme.
  - [x] Update `assets/images/title.png`, `assets/icons/app.png`, and related branding assets. (Placeholder capybara-themed images generated)
  - [x] Adjust `app.json` for app name and icon.
